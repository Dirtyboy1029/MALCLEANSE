...
def execute_selected_obfuscation(apkname, OBFUSCATION_LIST):
    NUM_OBFUS = len(OBFUSCATION_LIST)
...
if __name__ == "__main__":
    ...
    lp.add_argument("-v", "--variation", dest="variation", type=str,
    ...
    if args.action == "individual":
        ...
        OBFUSCATION_LIST = globals()['OBFUSCATION_' + args.variation.replace('v', '')]
        execute_selected_obfuscation(working_dir, OBFUSCATION_LIST)
